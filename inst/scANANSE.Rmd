...
set.seed(1234)
knitr::opts_knit$set(root.dir = normalizePath("input your working dir containing the scANANSE folder"))
```
...
Factor_Motif_Plot(pbmc, TF_list, assay_maelstrom = 'TFanticor', logo_dir = './scANANSE/analysis/maelstrom/logos/',col = c('darkred','white','grey'))
dev.off()

TF_list <- c('MEF2C','TCF7','ETS1','GATA3','MAX')
pdf('./scANANSE/analysis/Factor_Motif_TFcor.pdf',width=8,height=8,paper='special') 
Factor_Motif_Plot(pbmc, TF_list, assay_maelstrom = 'TFcor', logo_dir = './scANANSE/analysis/maelstrom/logos/', col = c('grey','white','darkgreen'))
dev.off()
