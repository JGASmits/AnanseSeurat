...
#' @examples 
#' sce <- import_seurat_scANANSE(sce, anansnake_inf_dir = './analysis/influence/')
#' sce <- import_seurat_scANANSE(sce, cluster_id = 'cluster', anansnake_inf_dir = './analysis/influence/')
#' @export
...
#' @examples 
#' sce <- import_seurat_maelstrom(sce, maelstrom_file  = './analysis/maelstrom/final.out.txt')
#' sce <- import_seurat_maelstrom(sce, cluster_id = 'cluster', maelstrom_file = './analysis/maelstrom/final.out.txt')
#' @export
...
#' @examples 
#' per_cluster_df(sce)
#' per_cluster_df(sce, assay = 'maelstrom', cluster_id = 'cluster')
#' per_cluster_df(sce, assay = ''MotifTFanticor'', cluster_id = 'cluster')
#' @export
